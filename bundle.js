...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _roomsRoomSectionJsx = __webpack_require__(160);

	var _roomsRoomSectionJsx2 = _interopRequireDefault(_roomsRoomSectionJsx);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'addRoom',
	    value: function addRoom(name) {
	      var rooms = this.state.rooms;

	      rooms.push({ id: rooms.length, name: name });
	      this.setState({ rooms: rooms });
	      // TODO: Send to server
	    }
	  }, {
	    key: 'setRoom',
	    value: function setRoom(activeRoom) {
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'nav' },
	          _react2['default'].createElement(_roomsRoomSectionJsx2['default'], _extends({}, this.state, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RoomFormJsx = __webpack_require__(161);

	var _RoomFormJsx2 = _interopRequireDefault(_RoomFormJsx);

	var _RoomListJsx = __webpack_require__(162);

	var _RoomListJsx2 = _interopRequireDefault(_RoomListJsx);

	var RoomSection = (function (_Component) {
	  _inherits(RoomSection, _Component);

	  function RoomSection() {
	    _classCallCheck(this, RoomSection);

	    _get(Object.getPrototypeOf(RoomSection.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(RoomSection, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'panel-body rooms' },
	          _react2['default'].createElement(_RoomListJsx2['default'], this.props),
	          _react2['default'].createElement(_RoomFormJsx2['default'], this.props)
	        )
	      );
	    }
	  }]);
	...
	RoomSection.propTypes = {
	  ...
	  setRoom: _react2['default'].PropTypes.func.isRequired,
	  addRoom: _react2['default'].PropTypes.func.isRequired,
	  activeRoom: _react2['default'].PropTypes.object.isRequired
	};

	exports['default'] = RoomSection;
	module.exports = exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RoomForm = (function (_Component) {
	  _inherits(RoomForm, _Component);

	  function RoomForm() {
	    _classCallCheck(this, RoomForm);

	    _get(Object.getPrototypeOf(RoomForm.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(RoomForm, [{
	    ...
	    value: function onSubmit(e) {
	      e.preventDefault();
	      var node = this.refs.room;
	      var roomName = node.value;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RoomJsx = __webpack_require__(163);

	var _RoomJsx2 = _interopRequireDefault(_RoomJsx);
	  ...
	  _createClass(RoomList, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'ul',
	        null,
	        this.props.rooms.map(function (chan) {
	          return _react2['default'].createElement(_RoomJsx2['default'], _extends({
	            room: chan,
	            key: chan.id
	          }, _this.props));
	        })
	...
	var Room = (function (_Component) {
	  ...
	  _createClass(Room, [{
	    ...
	    value: function render() {
	      ...
	      var activeRoom = _props2.activeRoom;

	      var active = room === activeRoom ? 'active' : '';
	      return _react2['default'].createElement(
	        'li',
	        { className: active },
	        _react2['default'].createElement(
